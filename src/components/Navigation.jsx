        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            <div className="bg-primary rounded-full p-1 group-hover:scale-110 transition-transform">
              <svg class="w-[30px] h-[30px] text-zinc-600 dark:text-zinc-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <path d="M12.215 13.773a1.792 1.792 0 1 0-1.786-1.8v.006a1.787 1.787 0 0 0 1.786 1.794Z"/>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="flex items-center gap-2 ml-2 border-l border-border/50 pl-2">
              ...
              <a href="https://github.com/Datheen" target="_blank" rel="noopener noreferrer" className="hidden md:block">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full"
